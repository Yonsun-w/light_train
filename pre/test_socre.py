...
class Model_eval(object):
    ...
    def eval(self, dataloader, model, time ,epoch=0):
        ...
        for i, (X, y) in enumerate(dataloader):
            ...
            pre_frames = pre_frames[:,0:time + 1]
            label = label[:,0:time + 1]
    ...
    def save_model(self, model, name, epoch):
        torch.save(model.state_dict(), os.path.join(self.config_dict['ModelFileDir'], '_{}_{}'.format(self.config_dict['NetName'], name)))
