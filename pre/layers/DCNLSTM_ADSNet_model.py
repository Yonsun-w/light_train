...
from layers.DCN_ConvLSTM import DCN_ConvLSTM2D
...
class DCNLSTM_Model(nn.Module):
    def __init__(self, obs_tra_frames, obs_channels, wrf_tra_frames, wrf_channels, config_dict):
        ...
        self.decoder_ConvLSTM = DCN_ConvLSTM2D(32, 128, kernel_size=5, img_rowcol=(config_dict['GridRowColNum']//2)//2)
