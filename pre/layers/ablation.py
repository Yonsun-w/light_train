...
class Ablation_without_transformer(nn.Module):
    def __init__(self, obs_tra_frames, obs_channels, wrf_tra_frames, wrf_channels, config_dict):
        super(Ablation_without_transformer, self).__init__()
        self.config_dict = config_dict
...
class Ablation_without_WBTE(nn.Module):
    def __init__(self, obs_tra_frames, obs_channels, wrf_tra_frames, wrf_channels, config_dict):
        super(Ablation_without_WBTE, self).__init__()
        self.config_dict = config_dict
        self.obs_tra_frames = obs_tra_frames
        self.wrf_tra_frames = wrf_tra_frames
        mn = (config_dict['GridRowColNum'] // 2) // 2
...
class Ablation_without_DCN(nn.Module):
    def __init__(self, obs_tra_frames, obs_channels, wrf_tra_frames, wrf_channels, config_dict):
        super(Ablation_without_DCN, self).__init__()
        self.config_dict = config_dict
        self.obs_tra_frames = obs_tra_frames
        self.wrf_tra_frames = wrf_tra_frames
        mn = (config_dict['GridRowColNum'] // 2) // 2
